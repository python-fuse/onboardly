    ...
    <div className="w-full flex justify-center px-4">
      ...
      >
        ...
        <div className="mt-4 flex flex-col items-center justify-center gap-3 w-full">
          <Button className="group relative flex h-14 w-full max-w-xs items-center justify-center overflow-hidden rounded-full bg-linear-to-r from-electric-blue to-vibrant-purple p-px shadow-[0_0_40px_-10px_rgba(139,92,246,0.5)] transition-all duration-300 hover:shadow-[0_0_60px_-15px_rgba(59,130,246,0.6)] hover:scale-[1.02]">
