...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-99 w-full border-b border-white/10 bg-background-dark/80 backdrop-blur-sm">
      <div
        ref={menuRef}
        className="max-w-7xl mx-auto flex items-center justify-between whitespace-nowrap px-4 sm:px-10 py-3 relative"
      >
        {/* Logo - Left */}
        <Link
          href="/"
